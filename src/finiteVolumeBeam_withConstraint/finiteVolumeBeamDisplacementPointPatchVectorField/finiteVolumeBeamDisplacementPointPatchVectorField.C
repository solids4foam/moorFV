...
#include "finiteVolumeBeamDisplacementPointPatchVectorField.H"
...
finiteVolumeBeamDisplacementPointPatchVectorField::
finiteVolumeBeamDisplacementPointPatchVectorField
(
    const pointPatch& p,
...
finiteVolumeBeamDisplacementPointPatchVectorField
(
    const finiteVolumeBeamDisplacementPointPatchVectorField& ptf,
    const pointPatch& p,
    const DimensionedField<vector, pointMesh>& iF,
...
void finiteVolumeBeamDisplacementPointPatchVectorField::autoMap
(
...
void finiteVolumeBeamDisplacementPointPatchVectorField::rmap
(
...
{
    const finiteVolumeBeamDisplacementPointPatchVectorField& sDoFptf =
        refCast<const finiteVolumeBeamDisplacementPointPatchVectorField>(ptf);
...
void finiteVolumeBeamDisplacementPointPatchVectorField::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
void finiteVolumeBeamDisplacementPointPatchVectorField::write(Ostream& os) const
{
