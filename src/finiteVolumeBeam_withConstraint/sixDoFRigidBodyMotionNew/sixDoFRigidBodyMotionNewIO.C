...
void Foam::sixDoFRigidBodyMotionNew::write(Ostream& os) const
{
    ...
    if (!constraints_.empty())
    {
        ...
        forAll(constraints_, rI)
        {
            ...
            os.writeKeyword("sixDoFRigidBodyMotionConstraintNew")
                << constraintType << token::END_STATEMENT << nl;

            constraints_[rI].sixDoFRigidBodyMotionConstraintNew::write(os);
...
Foam::Istream& Foam::operator>>(Istream& is, sixDoFRigidBodyMotionNew& sDoFRBM)
{
    ...
    (
        ...
        "(Foam::Istream&, Foam::sixDoFRigidBodyMotionNew&)"
    );
...
)
{
    ...
    (
        ...
        "const Foam::sixDoFRigidBodyMotionNew&)"
    );
