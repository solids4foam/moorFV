...
bool Foam::sixDoFRigidBodyMotionFvBeam::read(const dictionary& dict, const Time& time)
{
...
void Foam::sixDoFRigidBodyMotionFvBeam::write(Ostream& os) const
{
    ...
    if (!restraints_.empty())
    {
        ...
        forAll(restraints_, rI)
        {
            ...
            os.writeEntry("sixDoFRigidBodyMotionFvBeamRestraint", restraintType);
    ...
    if (!constraints_.empty())
    {
        ...
        forAll(constraints_, rI)
        {
            ...
            os.writeEntry("sixDoFRigidBodyMotionFvBeamConstraint", constraintType);

            constraints_[rI].sixDoFRigidBodyMotionFvBeamConstraint::write(os);
