...
void Foam::sixDoFRigidBodyMotionFvBeamState::write(dictionary& dict) const
{
...
void Foam::sixDoFRigidBodyMotionFvBeamState::write(Ostream& os) const
{
...
(
    Istream& is, sixDoFRigidBodyMotionFvBeamState& sDoFRBMS
)
{
...
(
    Ostream& os,
    const sixDoFRigidBodyMotionFvBeamState& sDoFRBMS
)
{
