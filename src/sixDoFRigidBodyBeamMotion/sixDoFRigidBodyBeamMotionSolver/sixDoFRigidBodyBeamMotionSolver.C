...
namespace Foam
{
    defineTypeNameAndDebug(sixDoFRigidBodyBeamMotionSolver, 0);

    addToRunTimeSelectionTable
    (
        motionSolver,
        sixDoFRigidBodyBeamMotionSolver,
        dictionary
    );
}
// * * * * * * * * * * * * * * private member functions  * * * * * * * * * * * * * //
void Foam::sixDoFRigidBodyBeamMotionSolver::cosineTransition
(
...
Foam::sixDoFRigidBodyBeamMotionSolver::sixDoFRigidBodyBeamMotionSolver
(
    const polyMesh& mesh,
...
const Foam::sixDoFRigidBodyBeamMotion&
Foam::sixDoFRigidBodyBeamMotionSolver::motion() const
{
    return motion_;
}
...
Foam::sixDoFRigidBodyBeamMotionSolver::curPoints() const
{
...
void Foam::sixDoFRigidBodyBeamMotionSolver::solve()
{
...
bool Foam::sixDoFRigidBodyBeamMotionSolver::writeObject
(
...
bool Foam::sixDoFRigidBodyBeamMotionSolver::read()
{
