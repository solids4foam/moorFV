...
void Foam::sixDoFRigidBodyBeamMotionState::write(dictionary& dict) const
{
...
void Foam::sixDoFRigidBodyBeamMotionState::write(Ostream& os) const
{
...
(
    Istream& is, sixDoFRigidBodyBeamMotionState& sDoFRBMS
)
{
...
(
    Ostream& os,
    const sixDoFRigidBodyBeamMotionState& sDoFRBMS
)
{
