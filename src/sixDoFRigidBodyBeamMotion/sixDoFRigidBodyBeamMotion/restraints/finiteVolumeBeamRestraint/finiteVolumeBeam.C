...
namespace Foam
{
namespace sixDoFRigidBodyBeamMotionRestraints
{
    defineTypeNameAndDebug(finiteVolumeBeam, 0);

    addToRunTimeSelectionTable
    (
        sixDoFRigidBodyBeamMotionRestraint,
        finiteVolumeBeam,
        dictionary
    );
}
...
Foam::sixDoFRigidBodyBeamMotionRestraints::finiteVolumeBeam::finiteVolumeBeam
(
    const word& name,
...
:
    sixDoFRigidBodyBeamMotionRestraint(name, sDoFRBMRDict,time),
    beam_
    (
        beamModel::New
        (
...
Foam::sixDoFRigidBodyBeamMotionRestraints::finiteVolumeBeam::
~finiteVolumeBeam()
{}
...
void Foam::sixDoFRigidBodyBeamMotionRestraints::finiteVolumeBeam::restrain
(
...
bool Foam::sixDoFRigidBodyBeamMotionRestraints::finiteVolumeBeam::read
(
    const dictionary& sDoFRBMRDict
)
{
    sixDoFRigidBodyBeamMotionRestraint::read(sDoFRBMRDict);
...
void Foam::sixDoFRigidBodyBeamMotionRestraints::finiteVolumeBeam::write
(
    Ostream& os
) const
{
