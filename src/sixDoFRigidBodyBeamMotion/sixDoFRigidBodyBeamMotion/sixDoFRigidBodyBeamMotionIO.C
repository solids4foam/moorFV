...
bool Foam::sixDoFRigidBodyBeamMotion::read(const dictionary& dict, const Time& time)
{
...
void Foam::sixDoFRigidBodyBeamMotion::write(Ostream& os) const
{
    ...
    if (!restraints_.empty())
    {
        ...
        forAll(restraints_, rI)
        {
            ...
            os.writeEntry("sixDoFRigidBodyBeamMotionRestraint", restraintType);
    ...
    if (!constraints_.empty())
    {
        ...
        forAll(constraints_, rI)
        {
            ...
            os.writeEntry("sixDoFRigidBodyBeamMotionConstraint", constraintType);

            constraints_[rI].sixDoFRigidBodyBeamMotionConstraint::write(os);
