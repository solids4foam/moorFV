...
#include "sixDoFRigidBodyBeamMotionPlaneConstraint.H"
...
Foam::sixDoFRigidBodyBeamMotionConstraints::plane::plane
(
    const word& name,
...
void Foam::sixDoFRigidBodyBeamMotionConstraints::plane::setCentreOfRotation
(
    point& CofR
) const
{
...
void Foam::sixDoFRigidBodyBeamMotionConstraints::plane::constrainTranslation
(
    pointConstraint& pc
) const
{
...
void Foam::sixDoFRigidBodyBeamMotionConstraints::plane::constrainRotation
(
    pointConstraint& pc
) const
{}
...
bool Foam::sixDoFRigidBodyBeamMotionConstraints::plane::read
(
    const dictionary& sDoFRBMCDict
)
{
...
void Foam::sixDoFRigidBodyBeamMotionConstraints::plane::write
(
    Ostream& os
) const
{
