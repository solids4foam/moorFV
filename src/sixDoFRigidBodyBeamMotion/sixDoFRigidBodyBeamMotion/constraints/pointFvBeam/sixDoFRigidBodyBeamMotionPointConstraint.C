...
#include "sixDoFRigidBodyBeamMotionPointConstraint.H"
...
Foam::sixDoFRigidBodyBeamMotionConstraints::point::point
(
    const word& name,
...
void Foam::sixDoFRigidBodyBeamMotionConstraints::point::setCentreOfRotation
(
    Foam::point& CofR
) const
{
...
void Foam::sixDoFRigidBodyBeamMotionConstraints::point::constrainTranslation
(
    pointConstraint& pc
) const
{
...
void Foam::sixDoFRigidBodyBeamMotionConstraints::point::constrainRotation
(
    pointConstraint& pc
) const
{}
...
bool Foam::sixDoFRigidBodyBeamMotionConstraints::point::read
(
    const dictionary& sDoFRBMCDict
)
{
...
void Foam::sixDoFRigidBodyBeamMotionConstraints::point::write
(
    Ostream& os
) const
{
